...
## Report on how do annual members and casual riders use Cyclistic bikes differently
...
This is my report on the Capstone Project of the Google Data Analytics
...
to be attained through customer behavior analysis, leading to a
...
iconic Lake Shore Drive to honor its city's 'founder' Jean Baptiste
...
Repeating previous step for the `end_station_name` column
...
Chicago, meaning there are less people commuting to and from work.
...
hottest month of the year, with an average high of 82?F and low of 70?F.

The number of rides through out the year correlates with the weather and
...
This tell us that casual riders prefer riding in summer and are more
...
the other hand it shows that members are majorly regular riders riding
...
About 14% of all Members rides take place from 7am to 9am, 16% from 11am
to 1pm and 27% from 4pm to 6pm, with 5pm being the peak. This indicates
that most members are local riders, who use bikes to commute work,
school and home, to run errands, or do other daily life activities.

The graph shows that about 25% of all casual rides take place at 4pm to
6pm, with 5pm being the peak. 1pm to 2pm is the only time that there are
...
afternoon and stop taking rides from 5pm onwards.
...
business district, which also is an indicative of the main purpose of
...
that visitors would buy annual membership.

#### Conclusion:

In conclusion, I have learned that there are numerous clear differences
between casual riders and members concerning their cycling behavior.
While both customer types take less bike trips during the winter
...
1.  The marketing campaign should be conducted at the time of the year
    ...
    August), on the weekends and during 1 to 2pm and 4 to 6pm.

2.  The marketing campaign should be conducted at the most popular areas
